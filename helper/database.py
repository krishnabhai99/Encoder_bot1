...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            thumbnail=None,
            ffmpegcode=None,
            metadata=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Animes_India_bot" -metadata author="@Krishna99887722" -metadata:s:s title="Subtitled By :- @new_animes_hindi_dub_india" -metadata:s:a title="By :- @new_animes_hindi_dub_india" -metadata:s:v title="By:- @new_animes_hindi_dub_india" """,
            ban_status=dict(
                is_banned=False,
                ban_duration=0,
